...
class Worker(object):
    ...
    def work(self):
        ...
        # savemat('D:/pythonWork/indoor Location/forth-code/saveModel/reward-100_NN100.mat', {'array': storeState})  # 存奖赏值

        self.env.final_states()
        # savemat('D:/pythonWork/indoor Location/forth-code/saveModel/action-100_NN100.mat', {'array': storeAction})   # 存动作列表
